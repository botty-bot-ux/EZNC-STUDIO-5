...
export const CanvasControls: React.FC<CanvasControlsProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <Crosshair className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400 shrink-0" />
        <div className="flex items-center gap-1">
          <span className="text-slate-400 dark:text-slate-500 font-semibold text-[11px]">X:</span>
        ...
        <div className="flex items-center gap-1">
          <span className="text-slate-400 dark:text-slate-500 font-semibold text-[11px]">Y:</span>
          <span className="w-14 text-right font-bold text-slate-800 dark:text-slate-100 tracking-tight">
            {cursorPos ? cursorPos.y.toFixed(2) : '0.00'}
          </span>
        </div>
        <span className="text-[10px] text-slate-400 dark:text-slate-500 font-medium ml-0.5">мм</span>
      </div>
      ...
      <button
        ...
        className="p-2 hover:bg-slate-100 hover:dark:bg-slate-700 rounded-xl transition-colors cursor-pointer shrink-0"
      >
        <ZoomOut className="w-4 h-4 text-slate-600 dark:text-slate-300" />
      </button>

      <span className="font-mono text-xs font-bold w-12 text-center text-slate-800 dark:text-slate-100 select-none shrink-0">
        {Math.round(zoom * 100)}%
      </span>
      ...
      <button
        ...
        className="p-2 hover:bg-slate-100 hover:dark:bg-slate-700 rounded-xl transition-colors text-slate-600 dark:text-slate-300 cursor-pointer shrink-0"
      >
