...
export const RightSidebar: React.FC = () => {
  ...
  return (
    <aside className={`absolute right-4 top-4 bottom-4 ${panelWidthClass} bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl border border-white/90 dark:border-slate-700/90 rounded-2xl shadow-2xl shadow-slate-900/15 text-slate-800 dark:text-slate-100 flex flex-col select-none z-20 overflow-hidden transition-all duration-200`}>
      {/* Top Header / Collapse Bar */}
      <div className="px-3 py-2 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-700/80 flex items-center justify-between shrink-0">
        <button
          onClick={toggleRightPanel}
