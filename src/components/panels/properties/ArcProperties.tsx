...
export const ArcProperties: React.FC<ArcPropertiesProps> = ({ obj, onUpdate }) => {
  return (
    <div className="space-y-2">
      ...
      {/*
        Нижний ряд: R, мм + три компактные иконочные кнопки справа (направление дуги,
        зеркало по горизонтали, зеркало по вертикали). Так панель свойств дуги заметно
        короче, чем раньше, где «Дуга:» и «Отзеркалить:» шли отдельными строками.
      */}
